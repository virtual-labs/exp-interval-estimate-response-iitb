function activity1_p7() {
    ...
    <p>$$ y = (a + bx_{0}) \\pm \\ \\sqrt{\\frac{SS_R}{n(n-2)S_{xx}}} t_{\\alpha_h, (n-2)}  $$</p>


    <p style='text-align: center;'><span style="display: inline-block;">$$ u = (a + bx_0) + \\sqrt{\\frac{SS_R}{n(n-2)S_{xx}}} \\ t_{\\alpha_h, (n-2)} = $$</span> <input type="text" class="form-control" style='display: inline-block; width: 200px;' id='a17-inp1' ></p>


    <p style='text-align: center;'><span style="display: inline-block;">$$ l = (a + bx_0) - \\sqrt{\\frac{SS_R}{n(n-2)S_{xx}}} \\ t_{\\alpha_h, (n-2)} = $$</span> <input type="text" class="form-control" style='display: inline-block; width: 200px;' id='a17-inp2' ></p>
...
function calculate_ul() {
    let p = Math.sqrt(ssr / (N * (N - 2) * sxx)) * t_n_2;
