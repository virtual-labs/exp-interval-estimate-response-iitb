...
function start_act2() {
    ...
    <p><span>$$ y = (a + bx_0) \\ \\pm \\ \\sqrt{\\frac{1}{n} + \\frac{(x_0 - \\overline{x})}{n-2}} \\  \\sqrt{\\frac{SS_r}{n-2}} \\ t_{\\alpha_{h}, n-2} $$</span></p>

    <p style='text-align: center;'><span style="display: inline-block;">$$ u = (a + bx_0) \\ + \\ \\sqrt{\\frac{1}{n} + \\frac{(x_0 - \\overline{x})}{n-2}} \\ \\sqrt{\\frac{SS_r}{n-2}} \\ t_{\\alpha_{h}, n-2} = $$</span> <input style='display: inline-block; width: 18vw;' type="text" class="form-control" id='act2_inp1' ></p>

    <p style='text-align: center;'><span style="display: inline-block;">$$ l = (a + bx_0) \\ - \\ \\sqrt{\\frac{1}{n} + \\frac{(x_0 - \\overline{x})}{n-2}} \\ \\sqrt{\\frac{SS_r}{n-2}} \\ t_{\\alpha_{h}, n-2} = $$</span> <input style='display: inline-block; width: 18vw;' type="text" class="form-control" id='act2_inp2' ></p>
...
function calculate_act2_u_l() {
    act2_calculated_u = (mat_x[1] + (mat_x[0] * X[X.length - 1])) + (Math.sqrt((1 / N) + ((X[X.length - 1] - X_avg) / (N - 2))) * Math.sqrt(ssr / (N - 2)) * t2_n_2);
    act2_calculated_l = (mat_x[1] + (mat_x[0] * X[X.length - 1])) - (Math.sqrt((1 / N) + ((X[X.length - 1] - X_avg) / (N - 2))) * Math.sqrt(ssr / (N - 2)) * t2_n_2);
}
